          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // 代码工具
                  _buildSection(context, '代码工具', Icons.code, [
                    _buildExtensionItem(
                      context,
                      '代码格式化',
                    ...
                    _buildExtensionItem(context, '代码模板', Icons.dashboard, () {
                      // TODO: 实现代码模板功能
                      ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  // 文件操作
                  _buildSection(context, '文件操作', Icons.folder, [
                    _buildExtensionItem(
                      context,
                      '批量重命名',
                    ...
                    _buildExtensionItem(context, '文件搜索', Icons.search, () {
                      // TODO: 实现文件搜索功能
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('文件搜索功能开发中')),
                      );
                    }),
                    _buildExtensionItem(context, '文件比较', Icons.compare, () {
                      // TODO: 实现文件比较功能
                      ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  // 开发工具
                  _buildSection(context, '开发工具', Icons.developer_mode, [
                    _buildExtensionItem(context, 'API测试', Icons.api, () {
                      // TODO: 实现API测试功能
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('API测试功能开发中')),
                      );
                    }),
                    _buildExtensionItem(context, '数据库管理', Icons.storage, () {
                      // TODO: 实现数据库管理功能
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('数据库管理功能开发中')),
                      );
                    }),
                    _buildExtensionItem(context, '性能分析', Icons.timeline, () {
                      // TODO: 实现性能分析功能
                      ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  // 系统工具
                  _buildSection(context, '系统工具', Icons.settings, [
                    _buildExtensionItem(context, '终端模拟器', Icons.terminal, () {
                      // TODO: 实现终端模拟器功能
                      ScaffoldMessenger.of(context).showSnackBar(
